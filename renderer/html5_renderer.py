...
def render_image_element(el: dict, idx: int, image_assignments: dict = None) -> str:
    """Render an image element using assigned image or placeholder."""
    css = render_element_css(el)
    # Check assignment first (by index), then element src
...
def build_html(layout: dict, click_url: str = "%%CLICK_URL_UNESC%%", fonts: list = None, image_assignments: dict = None) -> str:
...
def render(
    ...
    # Copy assigned images into banner assets
